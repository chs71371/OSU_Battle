...
public class Page_Menu : MonoBehaviour
{
    ...
    public void PlayGame()
    {
        ...
        Destroy(gameObject);
        var playUI = GameObject.Instantiate(Resources.Load("assetsbundles/ui/Page_GamePlay")) as GameObject;
        var videoUI = GameObject.Instantiate(Resources.Load("assetsbundles/ui/Page_video")) as GameObject;
    }
